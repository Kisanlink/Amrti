                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex items-center justify-between">
                        <div className="flex items-center space-x-2">
                          <span className="text-sm text-black-600">Qty:</span>
                          <button
                          ...
                          <span className="px-2 py-1 border border-gray-300 rounded min-w-[2rem] text-center">
                            {item.quantity}
                          </span>
                          <button
                            onClick={() => handleQuantityChange(item.product_id, item.quantity + 1)}
                        ...
                        <div className="text-right">
                          <p className="font-semibold text-green-600">₹{item.unit_price} each</p>
                          <p className="text-sm text-black-600">Total: ₹{item.total_price}</p>
                        </div>
                      </div>
                    </div>
            ...
            <div className="bg-white rounded-2xl shadow-xl p-6 sticky top-24">
              ...
              <div className="space-y-4 mb-6">
                <div className="flex justify-between">
                  <span className="text-black-700">Subtotal ({cart.total_items} items)</span>
              ...
              {/* Trust Badges */}
              <div className="grid grid-cols-3 gap-4 text-center text-xs text-black-600">
                <div>
