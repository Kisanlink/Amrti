...
const LogoDescriptionPanel = memo(({ isLeft }: { isLeft: boolean }) => (
  <motion.div
    ...
    className={`flex flex-col items-center justify-center h-full p-8 md:p-12 ${isLeft ? 'order-1' : 'order-2'}`}
    style={{
      willChange: 'auto',
  ...
  >
    <div className="text-center space-y-6">
      ...
      >
        <h1 className="text-3xl md:text-4xl lg:text-5xl font-heading font-bold text-green-800 tracking-wide leading-tight">
          NATURE'S ELIXIR
        </h1>
        <h2 className="text-xl md:text-2xl lg:text-3xl font-heading font-semibold text-green-700 tracking-wide">
          FOR YOUR WELLNESS
        </h2>
        <div className="pt-4 flex items-center justify-center space-x-4 text-green-600">
...
const Login = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-beige-400 to-beige-500 flex items-center justify-center pt-24 pb-12 px-4 sm:pt-28 sm:pb-12 sm:px-6 lg:pt-32 lg:pb-12 lg:px-8">
      <div className="w-full max-w-lg lg:max-w-6xl">
        ...
        <motion.div
          ...
          className="bg-white/95 backdrop-blur-md border border-white/20 rounded-3xl shadow-2xl overflow-hidden"
        >
          <div className="grid grid-cols-1 lg:grid-cols-2 min-h-[500px] lg:min-h-[600px]">
            ...
            <motion.div
              ...
              className={`p-8 md:p-12 flex flex-col justify-center w-full ${isSignup ? 'order-2 lg:order-2' : 'order-1 lg:order-1'}`}
            >
              <div className="max-w-md mx-auto w-full space-y-6">
                {/* Back to Home Link */}
                <Link 
                  to="/"
                  className="inline-flex items-center space-x-2 text-gray-700 hover:text-green-600 transition-colors duration-300 mb-4"
                >
                        ...
                        <form onSubmit={handleEmailLogin} className="space-y-6">
                          ...
                          <div className="space-y-3">
                            ...
                            <button
                              ...
                              disabled={loading}
                              className="w-full bg-white hover:bg-gray-50 text-gray-700 font-heading font-semibold py-3 px-6 rounded-xl border border-gray-200 shadow-md hover:shadow-lg transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center space-x-3"
                            >
                              {loading ? (
                                <>
                            ...
                            <button
                              ...
                              className="w-full border-2 border-gray-300 text-gray-700 hover:bg-gray-50 font-heading font-semibold py-3 px-6 rounded-xl transition-all duration-300 flex items-center justify-center space-x-2"
                            >
              ...
              <form onSubmit={handleVerifySubmit} className="space-y-6">
                  ...
                  {loading ? (
                    ...
                    >
                      {signupStep === 'email' ? (
                        ...
                        <form onSubmit={handleSignupPhoneSubmit} className="space-y-6">
                ...
                {/* Google Sign In/Up Button for Signup */}
                {isSignup && (
                  <div className="mt-6">
                    <div className="relative my-6">
                      <div className="absolute inset-0 flex items-center">
            ...
            {useMemo(() => (
              <motion.div
                ...
                transition={{ duration: 0.6, ease: "easeInOut" }}
                className={`hidden lg:flex flex-col items-center justify-center p-8 md:p-12 bg-gradient-to-br from-green-50/80 via-beige-50/80 to-green-50/80 ${isSignup ? 'order-1 lg:order-1' : 'order-2 lg:order-2'}`}
              >
